        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex flex-col gap-y-8 sm:flex-row">
                <div class="w-full sm:w-1/3 flex items-center justify-center">
                    <div>
                        <img class="rounded-photo w-11/12 mx-auto sm:mx-0" src="https://elements-video-cover-images-0.imgix.net/files/ddf31d2a-543c-4182-9ffa-d1a4f6d878ec/inline_image_preview.jpg?auto=compress%2Cformat&h=394&w=700&fit=min&s=104cee012a125e6a1aa53e475c8b8c7a" alt="image description">
                    </div>
                </div>
                <div class="w-full sm:w-2/3">
                    <div class="flex items-center justify-center sm:justify-start">
                        <div>
                            <h1 class="uppercase text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-none tracking-tight text-gray-900 dark:text-white">{{$colaborador->user->name}}<span class="text-blue-600 dark:text-blue-500"></span></h1>
                        </div>
                        <div class="bg-blue-300 rounded-lg ml-3 px-1.5">
                            <div class="flex items-center">
                                <div>
                                    <h5 class="font-black text-2xl sm:text-4xl">
                                        3.5
                                    </h5>
                                </div>
                                <div class="mb-1.5">
                    ...
                    <h3 class="mt-3 flex items-center justify-center sm:justify-start font-bold">Servicios que ofrece:</h3>
                    <div class="flex flex-wrap">
