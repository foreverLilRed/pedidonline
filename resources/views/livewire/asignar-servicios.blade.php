<div>
    ...
    <div class="flex flex-wrap">
        @foreach ($servicios as $servicio)
            <div class="m-1.5">
                <input wire:key="{{ $servicio->id }}" wire:model="servicioSeleccionados" type="checkbox" id="{{ $servicio->id }}" value="{{ $servicio->id }}" class="hidden peer" required="">
    ...
    <div class="mt-5 text-center">
        <a wire:click="guardarServicios" class="relative inline-flex items-center justify-start py-3 pl-4 pr-12 overflow-hidden font-semibold text-green-600 transition-all duration-150 ease-in-out rounded hover:pl-10 hover:pr-6 bg-gray-50 group">
